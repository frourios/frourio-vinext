---
name: frourio-vinext
description: Skills for building type-safe Vinext API routes with frourio-vinext. Covers project setup, adding endpoints, middleware, and client usage with SWR/TanStack Query.
